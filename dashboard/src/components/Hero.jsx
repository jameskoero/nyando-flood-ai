...
<h1 className="fade-up delay-1" style={{fontFamily:'Syne,sans-serif',fontSize:'clamp(2rem,8vw,3.5rem)',fontWeight:800,lineHeight:1.1,color:'#F0EAD6',marginBottom:'1.5rem'}}>Protecting<br/><span style={{color:'#C9A84C'}}>50,000 Residents</span><br/>from Flood Risk</h1>
